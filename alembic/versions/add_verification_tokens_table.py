...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_public_verification_tokens_token'), 'verification_tokens', ['token'], unique=True, schema='public')


def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(op.f('ix_public_verification_tokens_token'), table_name='verification_tokens', schema='public')
