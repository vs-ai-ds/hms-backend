...
api_router.include_router(stock_items.router, prefix="/stock-items", tags=["stock_items"])
api_router.include_router(patient_shares.router, prefix="/patient-shares", tags=["patient-shares"])
